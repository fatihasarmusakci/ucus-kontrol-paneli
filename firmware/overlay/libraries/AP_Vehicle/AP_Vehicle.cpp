...
const AP_Param::GroupInfo AP_Vehicle::var_info[] = {
    ...
    // @Group: EREC
    // @Path: ../AP_EnergyRecovery/AP_EnergyRecovery.cpp
    AP_SUBGROUPINFO(energy_recovery, "EREC", 33, AP_Vehicle, AP_EnergyRecovery),
#endif
...
#endif
#if AP_ENERGY_RECOVERY_ENABLED
    SCHED_TASK_CLASS(AP_EnergyRecovery, &vehicle.energy_recovery, update,
                     AP_LOP_EREC_SCHED_HZ, AP_LOP_EREC_SCHED_MAX_US, AP_LOP_EREC_SCHED_PRIORITY),
#endif
#if OSD_ENABLED
